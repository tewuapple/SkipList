...
namespace SkipList
{
    ...
    public class SkipList : IDictionary
    {
        ...
        private bool Search(object key, out Node curr, Node[] update)
        {
            ...
            if (key == null)
            {
                string msg = "An attempt was made to pass a null key to a SkipList.";
            ...
            Node[] update)
        {
            ...
            {
                string msg = "The SkipList was set to use the IComparable interface and an attempt was made to add a key that does not support this interface.";
        ...
        private class SkipListEnumerator : IDictionaryEnumerator
        {
            ...
            public DictionaryEntry Entry
            {
                get
                {
                    ...
                    {
                        string msg = "SkipListEnumerator is no longer valid. The SkipList has been modified since the creation of this enumerator.";
                    ...
                    {
                        string msg = "An attempt was made to access a SkipListEnumerator that is positioned before the first element of a SkipList or after the last element. ";
        ...
        public void Add(object key, object value)
        {
            ...
            {
                string msg = "An attempt was made to add an element in which the key of the element already exists in the SkipList.";
                throw new ArgumentException(msg);
            }
        }
        ...
        public void CopyTo(Array array, int index)
        {
            ...
            if (array == null)
            {
                string msg = "An attempt was made to pass a null array to the CopyTo method of a SkipList.";
                throw new ArgumentNullException(msg);
            }
            // Make sure index is not negative.
            else if (index < 0)
            {
                string msg = "An attempt was made to pass an out of range index to the CopyTo method of a SkipList.";
